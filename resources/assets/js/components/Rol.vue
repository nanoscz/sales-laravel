          ...
          <table class="table table-bordered table-striped table-sm">
            ...
            <tbody>
              <tr v-for="rol in roles" :key="rol.id">
                <td>
                  <button
                    ...
                    class="btn btn-warning btn-sm"
										@click="openModal('rol','update', rol)">
                ...
                <td>
									<div v-if="rol.state">
                  	<span @click="changeState(rol.id)" class="badge badge-success">active</span>
									</div>
									<div v-else>
                  	<span @click="changeState(rol.id)" class="badge badge-danger">desactive</span>
									</div>
                </td>
              </tr>
            </tbody>
...
export default {
  ...
  methods: {
    show(page, search, option) {
			let ctrl = this;
			let url = '/rol?page=' + page + '&search=' + search + '&option=' + option;
      axios
        .get(url)
        .then(function(res) {
					console.log(res);
					let response = res.data;
					ctrl.roles = response.roles.data;
