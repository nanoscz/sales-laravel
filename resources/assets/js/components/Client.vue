        ...
        <div class="card-header">
          ...
          <button
            ...
            class="btn btn-secondary"
						@click="openModal('client','register')">
          ...
          <table class="table table-bordered table-striped table-sm">
            ...
            <tbody>
              <tr v-for="client in clients" :key="client.id">
                <td>
                  <button
                    ...
                    class="btn btn-warning btn-sm"
										@click="openModal('client','update', client)">
                ...
                <td v-text="client.direction"></td>
								<td v-text="client.phone"></td>
                <td v-text="client.email"></td>
                <td>
									<div v-if="client.state">
                  	<span @click="changeState(client.id)" class="badge badge-success">active</span>
									</div>
									<div v-else>
                  	<span @click="changeState(client.id)" class="badge badge-danger">desactive</span>
									</div>
                </td>
              </tr>
            </tbody>
...
export default {
  ...
  methods: {
    show(page, search, option) {
			console.log(page);
			let ctrl = this;
			let url = '/client?page=' + page + '&search=' + search + '&option=' + option;
      axios
        .get(url)
        .then(function(res) {
					console.log(res);
					let response = res.data;
					ctrl.clients = response.clients.data;
